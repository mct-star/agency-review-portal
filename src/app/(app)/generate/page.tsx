...
type GenerationScope = "single_post" | "single_blog" | "single_article" | "single_pdf" | "full_week" | "full_month";
...
const SCOPE_OPTIONS: { id: GenerationScope; label: string; description: string; icon: string; minPlan: PlanTier }[] = [
  ...
  {
    id: "single_pdf" as GenerationScope,
    label: "PDF Guide",
    description: "Generate a branded PDF guide or downloadable resource from a topic.",
...
export default function GeneratePage() {
  ...
  const handleGenerateSingle = useCallback(async () => {
    ...
    const contentType = selectedScope === "single_blog" ? "blog_article"
      ...
      : selectedScope === "single_pdf" ? "pdf_guide"
      : "social_post";
