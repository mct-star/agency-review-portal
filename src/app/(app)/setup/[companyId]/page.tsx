...
export default async function CompanyOverviewPage({ params }: PageProps) {
  ...
  const stats = [
    { label: "Strategy", value: blueprintCount || 0 > 0 ? "Active" : "None", href: "strategy" },
    { label: "Schedule", value: "Configure", href: "schedule" },
    { label: "Topics", value: topicCount || 0, href: "topics" },
    { label: "Voice", value: "Configure", href: "voice" },
    { label: "Sign-offs", value: "Configure", href: "signoffs" },
    { label: "API Keys", value: apiConfigCount || 0, href: "api-keys" },
    { label: "Social", value: socialCount || 0, href: "social" },
  ];
        ...
        {stats.map((stat) => {
          ...
          if (stat.href) {
            return (
              <Link
                key={stat.label}
                href={`/setup/${companyId}/${stat.href}`}
