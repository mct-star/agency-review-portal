...
import VoiceToPostPage from "@/components/create/VoiceToPost";

export const metadata: Metadata = {
  title: "Voice to Post | AGENCY",
  description: "Record a voice note and turn it into a polished LinkedIn post",
};
